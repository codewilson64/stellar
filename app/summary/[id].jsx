...
//   return (
//     <View style={{ flex: 1, backgroundColor: isDark ? '#181818' : '#FFFFFF' }}>
//       {/* Toggle Button */}
//       <View
//         className={`px-5 py-3 flex-row justify-between items-center border ${
//           isDark ? 'border-b-gray-600/50' : 'border-b-gray-300/60'
//         } border-l-0 border-r-0 border-t-0`}
//       >
//         <Pressable onPress={router.back}>
//           <Image
//             source={arrow}
//             style={{ tintColor: isDark ? 'gray' : 'black' }}
//             className="size-6"
//           />
//         </Pressable>
//         <Pressable onPress={toggleTheme} className="bg-gray-300/30 p-2 rounded-full">
...
//           <View key={item.id.toString()} style={{ marginBottom: 32 }}>
//             <Text
//               style={{
...
//             </Text>
//             <Text
//               style={{ color: isDark ? '#E5E7EB' : '#000', fontSize: 18 }}
...
//         <Pressable
//           onPress={router.back}
//           className="bg-[#13a2f5] px-4 py-3 rounded-lg self-center mt-8"
//         >
//           <Text className="text-white text-base font-semibold">Finish summary</Text>
//         </Pressable>
//       </ScrollView>

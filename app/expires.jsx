...
export default function ExpiresScreen() {
      ...
      <ScrollView contentContainerStyle={{paddingBottom: 40}}>
        <View className='px-5'>
          <View className='py-3'>
            ...
            <View className='flex-col items-start gap-8 mt-5'>
              <Text className='font-bold text-[#E5E7EB] text-3xl leading-snug'>Your premium access has expired</Text>
              <Text className='font-normal text-[#E5E7EB] text-lg'>
                Your premium access may be over, but your growth is just beginning. Continue your Premium and keep expanding your mind every day.
              </Text>

              <View className='border border-gray-300/60 rounded-2xl overflow-hidden'>
                <View className='w-full'>
                  <View className='p-5 bg-orange-400/20'>
                    <Text className='text-md font-semibold text-orange-500 tracking-wider'>WITHOUT PREMIUM, YOU LOSE</Text>
                  </View>

                  <View className='flex-col p-5 gap-3 bg-[#2c2c2c]'>
                    <View className='flex-row items-center gap-3'>
                        <Image source={x} style={{ tintColor: '#f97316' }} className='size-5' />
                        <Text className='text-lg font-semibold text-[#E5E7EB]'>Access to all book summaries</Text>
                    </View>
                    <View className='flex-row items-center gap-3'>
                        <Image source={x} style={{ tintColor: '#f97316' }} className='size-5' />
        ...
        {/* Bottom fixed section */}
          <View className="absolute bottom-0 left-0 right-0 px-5 pb-5">
            <View className='flex-col gap-7'>
              ...
              <Pressable onPress={() => setOpenModal(true)} className='mb-5'>
